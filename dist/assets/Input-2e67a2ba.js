...
`,[C(">",[l("clear",`
 ...
 `,[an({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),he=k({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(n){return Se("-base-clear",$n,de(n,"clsPrefix")),{handleMouseDown(f){f.preventDefault()}}},render(){const{clsPrefix:n}=this;return r("div",{class:`${n}-base-clear`},r(ln,null,{default:()=>{var f,t;return this.show?r("div",{key:"dismiss",class:`${n}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},U(this.$slots.icon,()=>[r(oe,{clsPrefix:n},{default:()=>r(Pn,null)})])):r("div",{key:"icon",class:`${n}-base-clear__placeholder`},(t=(f=this.$slots).placeholder)===null||t===void 0?void 0:t.call(f))}}))}}),En=k({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(n,{slots:f}){return()=>{const{clsPrefix:t}=n;return r(sn,{clsPrefix:t,class:`${t}-base-suffix`,strokeWidth:24,scale:.85,show:n.loading},{default:()=>n.showArrow?r(he,{clsPrefix:t,show:n.showClear,onClear:n.onClear},{placeholder:()=>r(oe,{clsPrefix:t,class:`${t}-base-suffix__arrow`},{default:()=>U(f.default,()=>[r(Fn,null)])})}):null})}}}),_e=cn("n-input");function kn(n){let f=0;for(const t of n)f++;return f}function ee(n){return n===""||n==null}function In(n){const f=w(null);function t(){const{value:b}=n;if(!(b!=null&&b.focus)){_();return}const{selectionStart:d,selectionEnd:s,value:u}=b;if(d==null||s==null){_();return}f.value={start:d,end:s,beforeText:u.slice(0,d),afterText:u.slice(s)}}function A(){var b;const{value:d}=f,{value:s}=n;if(!d||!s)return;const{value:u}=s,{start:c,beforeText:i,afterText:p}=d;let m=u.length;if(u.endsWith(p))m=u.length-p.length;else if(u.startsWith(i))m=i.length;else{const I=i[c-1],S=u.indexOf(I,c-1);S!==-1&&(m=S+1)}(b=s.setSelectionRange)===null||b===void 0||b.call(s,m,m)}function _(){f.value=null}return fe(n,_),{recordCursor:t,restoreCursor:A}}const ze=k({name:"InputWordCount",setup(n,{slots:f}){const{mergedValueRef:t,maxlengthRef:A,mergedClsPrefixRef:_,countGraphemesRef:b}=un(_e),d=B(()=>{const{value:s}=t;return s===null||Array.isArray(s)?0:(b.value||kn)(s)});return()=>{const{value:s}=A,{value:u}=t;return r("span",{class:`${_.value}-input-word-count`},dn(f.default,{value:u===null||Array.isArray(u)?"":u},()=>[s===void 0?d.value:`${d.value} / ${s}`]))}}}),Tn=x("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
